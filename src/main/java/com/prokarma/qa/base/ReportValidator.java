...
//							    		 System.out.println(output_header_str+" not matching "+output_header_data+" "+report_header_data);
	...
	public void validateSpendConsumptionReportRandomRecords() throws Throwable {
		...
		int exlObj_spendConsumptionYOY_colCount=exlObj_spendConsumptionYOY.colCount("Data", 0);
		exlObj_spendConsumptionYOY.setDataInOther(downloaded_SpendConsumptionYOY_ReportFilePath, "Data", 0, exlObj_spendConsumptionYOY_colCount, "Status");
...
//					 }  
						 ...
						 if(row_status==true) {	
							 ...
							 int row_statusColIndex=colCountYOY;							 
				    ...
				    int colCountYOY=exlObj_spendConsumptionYOY.colCount("Data", 0);
					int row_status_colindex=colCountYOY;
